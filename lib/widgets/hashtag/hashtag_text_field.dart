...
class _TextFieldSelectionGestureDetectorBuilder
  ...
  _TextFieldSelectionGestureDetectorBuilder({
    required HashTagTextFieldState state,
  })  : _state = state,
        super(delegate: state);

  final HashTagTextFieldState _state;
...
class HashTagTextField extends StatefulWidget {
  ...
  @override
  HashTagTextFieldState createState() => HashTagTextFieldState();
...
class HashTagTextFieldState extends State<HashTagTextField>
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle style =
        theme.textTheme.bodyMedium!.merge(widget.basicStyle);
    final Brightness keyboardAppearance =
