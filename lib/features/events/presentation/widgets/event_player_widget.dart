...
class EventPlayerWidget extends ConsumerStatefulWidget {
  ...
  final String videoOrImageUrl;

  const EventPlayerWidget({
    super.key,
    required this.thumbnailUrl,
    required this.videoOrImageUrl,
...
class _EventPlayerWidgetState extends ConsumerState<EventPlayerWidget> {
  ...
  void initState() {
    super.initState();
    isVideo = widget.thumbnailUrl != widget.videoOrImageUrl &&
        widget.videoOrImageUrl.isNotEmpty;
    ...
    controller = BetterPlayerController(
      ...
      betterPlayerDataSource: BetterPlayerDataSource.network(
        '${widget.cdnUrl}/${widget.videoOrImageUrl}',
            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    ref
                        .read(eventPlayerControllerProvider.notifier)
                        .toggleMute();
                  },
                  child: Icon(
