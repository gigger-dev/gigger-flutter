...
part 'gig_list_out.freezed.dart';
part 'gig_list_out.g.dart';

@Freezed()
abstract class GigListOut with _$GigListOut {
  const factory GigListOut({
  ...
  factory GigListOut.fromJson(Map<String, Object?> json) =>
      _$GigListOutFromJson(json);
}
